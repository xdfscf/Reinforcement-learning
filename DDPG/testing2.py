...
actor_model.load_weights("./saved_model/actor_1_DDPG_boundary_10.h5")
# CHOOSING THE MODE
train = False
seeds=[42,43,44]
...
for timestep in range(0, 12 * 30 * 24 * 60):
    ...
    overflow2.append(0)
    energy2.append(env.total_energy2)
...
plt.plot(times, ai_energy, color='r', label='DDPG(2) controller', linewidth=2)
plt.plot(times, energy, color='g', label='violent method', linewidth=2)
plt.plot(times, energy2, color='b', label='traditional controller', linewidth=2)
plt.xlabel("time step")
plt.ylabel("energy consumption")
...
plt.plot(times, ai_overflow, color='r', label='DDPG(2) controller', linewidth=2)
plt.plot(times, overflow, color='g', label='violent method', linewidth=2)
plt.plot(times, overflow2, color='b', label='traditional controller', linewidth=2)
plt.xlabel("time step")
plt.ylabel("Overflow times")
plt.legend()
plt.show()
