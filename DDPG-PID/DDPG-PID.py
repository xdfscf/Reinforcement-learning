...
#actor_model.load_weights("pendulum_actor_bound1_10_6_470.h5")
#critic_model.load_weights("pendulum_critic_bound1_10_6_470.h5")

target_actor = get_actor()
target_critic = get_critic()

#target_actor.load_weights("pendulum_actor_bound1_10_6_470.h5")
#target_critic.load_weights("pendulum_critic_bound1_10_6_470.h5")
...
if __name__ == '__main__':
    ...
    #    print("current episode reward: " + episodic_reward)
        ...
        if ep>600 and ep<3000 and ep%60==1:
            print("hhh")
            counters+=1
            string1="pendulum_actor_bound1_2_1_"+str(counters)+".h5"
            string2="pendulum_critic_bound1_2_1_"+str(counters)+".h5"
            string3="pendulum_target_actor_bound1_2_1_"+str(counters)+".h5"
            string4="pendulum_target_critic_bound1_2_1_"+str(counters)+".h5"
